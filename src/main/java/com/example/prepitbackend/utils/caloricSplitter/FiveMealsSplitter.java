...
public class FiveMealsSplitter implements MealSplitter{

    private static int MEALS_BREAKFAST_PERCENTAGE_START = 27;
    private static int MEALS_LUNCH_PERCENTAGE_START = 37;
    private static int MEALS_DINNER_PERCENTAGE_START = 17;
    private static int MEALS_SNACK_PERCENTAGE_START = 7;
    
    private static int MEALS_BREAKFAST_PERCENTAGE_END = 29;
    private static int MEALS_LUNCH_PERCENTAGE_END = 39;
    private static int MEALS_DINNER_PERCENTAGE_END = 19;
